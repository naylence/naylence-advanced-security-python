...
async def test_certificate_manager():
    ...
    DefaultCertificateManager(security_settings=raw_key_profile)
    ...
    DefaultCertificateManager(security_settings=x509_profile)
    ...
    # Test 5: Mock welcome frame for child test
    mock_welcome = Mock()
    ...
    # Test 6: Mock welcome frame with X509 security profile
